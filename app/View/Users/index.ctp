<div class="users index">
	...
	<tr>
		...
		<td><?php echo h($user['User']['usuario_lol']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['liga']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['divisao']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['foto']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['fl_permite_divulgar']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['infadicional_id']); ?>&nbsp;</td>
		<td class="actions">
