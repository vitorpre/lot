<div class="champions index">
	...
	<tr>
		...
		<td><?php echo h($champion['Champion']['nome']); ?>&nbsp;</td>
		<td><?php echo h($champion['Champion']['foto']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $champion['Champion']['id']), array(), __('Are you sure you want to delete # %s?', $champion['Champion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
